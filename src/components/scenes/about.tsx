...
export function AboutScene() {
  return (
    <Section id="about" label="01 — About" fullHeight>
      <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-start">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-black tracking-tight leading-tight">
            <span className="text-fg-muted">Building </span>
            <span className="text-fg">at the intersection of </span>
            <span className="text-accent">AI</span>
            <span className="text-fg">, </span>
            <span className="text-accent">mobile</span>
            <span className="text-fg">, and </span>
